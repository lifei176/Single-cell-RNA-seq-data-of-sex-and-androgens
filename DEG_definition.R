library(Seurat)
library(ggplot2)
setwd("E:/lifei/androgen_project/20211216_Reanalyses/DEG/")
...
brain.combined.filter.integrated <- readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/brain.combined.filter.integrated.rds")
lung.combined.filter.integrated <- readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/lung.combined.filter.integrated.rds")
pancreas.combined.filter.integrated <- readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/pancreas.combined.filter.integrated.rds")
spleen.combined.filter.integrated <- readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/spleen.combined.filter.integrated.rds")
stomach.combined.filter.integrated <- readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/stomach.combined.filter.integrated.rds")

adipose.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/adipose.combined.filter.integrated.rds")
heart.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/heart.combined.filter.integrated.rds")
kidney.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/kidney.combined.filter.integrated.rds")
skeletalmuscle.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/skeletalmuscle.combined.filter.integrated.rds")

adrenal.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/adrenal.combined.filter.integrated.rds")
bone_marrow.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/bone_marrow.combined.filter.integrated.rds")
liver.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/liver.combined.filter.integrated.rds")
salivary.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/salivary.combined.filter.integrated.rds")
thymus.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/thymus.combined.filter.integrated.rds")

colon.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/colon.combined.filter.integrated.rds")
intestine.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/intestine.combined.filter.integrated.rds")
lacrimal.combined.filter.integrated<-readRDS("E:/lifei/androgen_project/20211216_Reanalyses/object_data/lacrimal.combined.filter.integrated.rds")
